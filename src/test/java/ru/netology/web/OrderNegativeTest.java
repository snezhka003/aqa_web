...
public class OrderNegativeTest {
    ...
    @Test
    void shouldBeFailedOrderByEmptyName() {
    ...
    @Test
    void shouldBeFailedOrderByEmptyPhone() {
    ...
    @Test
    void shouldBeFailedOrderByEmptyCheckbox() {
        driver.findElement(By.cssSelector("[data-test-id=name] input")).sendKeys("Петров-Водкин Артем");
        driver.findElement(By.cssSelector("[data-test-id=phone] input")).sendKeys("+79001234567");
        driver.findElement(By.tagName("button")).click();
    ...
    @Test
    void shouldBeFailedOrderByInvalidName() {
    ...
    @Test
    void shouldBeFailedOrderByInvalidPhone() {
        driver.findElement(By.cssSelector("[data-test-id=name] input")).sendKeys("Петров-Водкин Артем");
        driver.findElement(By.cssSelector("[data-test-id=phone] input")).sendKeys("+790012345");
        driver.findElement(By.cssSelector("[data-test-id=agreement]")).click();
        driver.findElement(By.tagName("button")).click();
        String text = driver.findElement(By.cssSelector("[data-test-id=phone].input_invalid .input__sub")).getText();
